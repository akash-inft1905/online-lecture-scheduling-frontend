...
const FormContainer = styled.div`
  ...
  form {
    ...
    flex-direction: column;
    gap: 2rem;
    background-color: #bcd7dd; /* Silken Ivory */
    border-radius: 1rem;
    padding: 2rem;
...
const Input = styled.input`
  ...
  &:focus {
    border: 2px solid black; /* Rose Gold Focus Border */
    outline: none;
  }
`;
...
const SubmitButton = styled.button`
  background-color: rgb(231 252 255); /* Golden Honey */
  color: black;
  padding: 1rem 2rem;
  border: none;
  font-weight: bold;
